...
class WorkoutCalculator {
  ...
  WorkoutCalculator({
    ...
    this.activityType = ActivityType.running, // Default activity type
  ...
  WorkoutCalculationResult processData() {
    ...
    for (final currentPosition in rawPositions) {
      ...
      if (timeDeltaSeconds >= minTimeDeltaSeconds) {
        ...
        final double maxSpeed =
            maxSpeedThresholds[activityType] ??
